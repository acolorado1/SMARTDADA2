...
class MyTestCase(unittest.TestCase):
    def test_trim_ends_less_than_threshold(self):
        known_list = [15.0, 20.0, 22.0, 30.0, 30.0, 40.0,
                      30.0, 30.0, 25.0, 20.0, 15.0]
        ...
        self.assertRaises(TypeError,
                          GTP.trim_ends_less_than_threshold, string_list)
        ...
        trim_L_short = [15.0, 18.0, 18.0, 30.0, 30.0, 40.0,
                        30.0, 30.0, 25.0, 20.0, 15.0]
        trim_R_short = [15.0, 20.0, 22.0, 30.0, 30.0, 40.0,
                        30.0, 30.0, 18.0, 18.0, 15.0]
        ...
        perfect_list = [30.0, 30.0, 30.0, 30.0, 30.0, 40.0,
    ...
    def test_get_trim_length_avgEE(self):
        # raise errors
        wrong_type = ['1', 2, 3]
        self.assertRaises(TypeError, GTP.get_trim_length_avgEE,
                          wrong_type, 1, 2)
